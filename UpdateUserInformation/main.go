...
func main() {
	...
	UpdateUserInformation := router.PathPrefix("/UpdateUserInformation").Subrouter()

	UpdateUserInformation.HandleFunc("", UpdateUserInformationHandler).Methods(http.MethodPost)
